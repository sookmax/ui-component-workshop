import{j as l}from"./jsx-runtime-3cfe299f.js";import{M as ve,f as ie,m as _e}from"./benefit-of-regular-exercise-b33d2a55.js";import{_ as p}from"./extends-98964cd2.js";import{R as a}from"./index-c4905b50.js";import{$ as ye}from"./index-ad15057c.js";import{$ as xe,a as Ie}from"./index-7f8e0d46.js";import{a as Ae,$ as ce}from"./index-f2f799ef.js";import{$ as le,a as we}from"./index-027e524b.js";import{c as de,$ as Ce,a as Ee,b as Se}from"./index-852d3ff3.js";import{$ as Ne}from"./index-c7280168.js";import{g as Re}from"./_commonjsHelpers-042e6b4d.js";import{b as je}from"./react-icons.esm-bc0d759c.js";const m="Accordion",Me=["Home","End","ArrowDown","ArrowUp","ArrowLeft","ArrowRight"],[U,Oe,Pe]=xe(m),[A,vt]=ye(m,[Pe,de]),B=de(),fe=a.forwardRef((e,r)=>{const{type:t,...o}=e,s=o,n=o;return a.createElement(U.Provider,{scope:e.__scopeAccordion},t==="multiple"?a.createElement(De,p({},n,{ref:r})):a.createElement(Te,p({},s,{ref:r})))});fe.propTypes={type(e){const r=e.value||e.defaultValue;return e.type&&!["single","multiple"].includes(e.type)?new Error("Invalid prop `type` supplied to `Accordion`. Expected one of `single | multiple`."):e.type==="multiple"&&typeof r=="string"?new Error("Invalid prop `type` supplied to `Accordion`. Expected `single` when `defaultValue` or `value` is type `string`."):e.type==="single"&&Array.isArray(r)?new Error("Invalid prop `type` supplied to `Accordion`. Expected `multiple` when `defaultValue` or `value` is type `string[]`."):null}};const[pe,ke]=A(m),[ue,Ve]=A(m,{collapsible:!1}),Te=a.forwardRef((e,r)=>{const{value:t,defaultValue:o,onValueChange:s=()=>{},collapsible:n=!1,...i}=e,[c,d]=le({prop:t,defaultProp:o,onChange:s});return a.createElement(pe,{scope:e.__scopeAccordion,value:c?[c]:[],onItemOpen:d,onItemClose:a.useCallback(()=>n&&d(""),[n,d])},a.createElement(ue,{scope:e.__scopeAccordion,collapsible:n},a.createElement(me,p({},i,{ref:r}))))}),De=a.forwardRef((e,r)=>{const{value:t,defaultValue:o,onValueChange:s=()=>{},...n}=e,[i=[],c]=le({prop:t,defaultProp:o,onChange:s}),d=a.useCallback($=>c((u=[])=>[...u,$]),[c]),b=a.useCallback($=>c((u=[])=>u.filter(C=>C!==$)),[c]);return a.createElement(pe,{scope:e.__scopeAccordion,value:i,onItemOpen:d,onItemClose:b},a.createElement(ue,{scope:e.__scopeAccordion,collapsible:!0},a.createElement(me,p({},n,{ref:r}))))}),[Fe,w]=A(m),me=a.forwardRef((e,r)=>{const{__scopeAccordion:t,disabled:o,dir:s,orientation:n="vertical",...i}=e,c=a.useRef(null),d=Ae(c,r),b=Oe(t),u=Ie(s)==="ltr",C=we(e.onKeyDown,x=>{var E;if(!Me.includes(x.key))return;const ge=x.target,S=b().filter(O=>{var P;return!((P=O.ref.current)!==null&&P!==void 0&&P.disabled)}),I=S.findIndex(O=>O.ref.current===ge),H=S.length;if(I===-1)return;x.preventDefault();let f=I;const N=0,R=H-1,j=()=>{f=I+1,f>R&&(f=N)},M=()=>{f=I-1,f<N&&(f=R)};switch(x.key){case"Home":f=N;break;case"End":f=R;break;case"ArrowRight":n==="horizontal"&&(u?j():M());break;case"ArrowDown":n==="vertical"&&j();break;case"ArrowLeft":n==="horizontal"&&(u?M():j());break;case"ArrowUp":n==="vertical"&&M();break}const he=f%H;(E=S[he].ref.current)===null||E===void 0||E.focus()});return a.createElement(Fe,{scope:t,disabled:o,direction:s,orientation:n},a.createElement(U.Slot,{scope:t},a.createElement(ce.div,p({},i,{"data-orientation":n,ref:d,onKeyDown:o?void 0:C}))))}),k="AccordionItem",[Ue,Y]=A(k),Be=a.forwardRef((e,r)=>{const{__scopeAccordion:t,value:o,...s}=e,n=w(k,t),i=ke(k,t),c=B(t),d=Ne(),b=o&&i.value.includes(o)||!1,$=n.disabled||e.disabled;return a.createElement(Ue,{scope:t,open:b,disabled:$,triggerId:d},a.createElement(Ce,p({"data-orientation":n.orientation,"data-state":be(b)},c,s,{ref:r,disabled:$,open:b,onOpenChange:u=>{u?i.onItemOpen(o):i.onItemClose(o)}})))}),Ye="AccordionHeader",qe=a.forwardRef((e,r)=>{const{__scopeAccordion:t,...o}=e,s=w(m,t),n=Y(Ye,t);return a.createElement(ce.h3,p({"data-orientation":s.orientation,"data-state":be(n.open),"data-disabled":n.disabled?"":void 0},o,{ref:r}))}),L="AccordionTrigger",He=a.forwardRef((e,r)=>{const{__scopeAccordion:t,...o}=e,s=w(m,t),n=Y(L,t),i=Ve(L,t),c=B(t);return a.createElement(U.ItemSlot,{scope:t},a.createElement(Ee,p({"aria-disabled":n.open&&!i.collapsible||void 0,"data-orientation":s.orientation,id:n.triggerId},c,o,{ref:r})))}),Le="AccordionContent",ze=a.forwardRef((e,r)=>{const{__scopeAccordion:t,...o}=e,s=w(m,t),n=Y(Le,t),i=B(t);return a.createElement(Se,p({role:"region","aria-labelledby":n.triggerId,"data-orientation":s.orientation},i,o,{ref:r,style:{["--radix-accordion-content-height"]:"var(--radix-collapsible-content-height)",["--radix-accordion-content-width"]:"var(--radix-collapsible-content-width)",...e.style}}))});function be(e){return e?"open":"closed"}const Ke=fe,We=Be,Ge=qe,Je=He,Qe=ze;var $e={exports:{}};/*!
