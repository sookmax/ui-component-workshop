...
>(({ className, inset, onSelect, onSelectClose = true, ...props }, ref) => {
  const _onSelect: React.ComponentPropsWithoutRef<
    typeof MenubarPrimitive.Item
  >["onSelect"] = (e) => {
    !onSelectClose && e.preventDefault();
    onSelect?.(e);
  };
...
>(
  (
    { className, children, checked, onSelect, onSelectClose = true, ...props },
    ref
  ) => {
    const _onSelect: React.ComponentPropsWithoutRef<
      typeof MenubarPrimitive.Item
...
>(({ className, children, onSelect, onSelectClose, ...props }, ref) => {
  const _onSelect: React.ComponentPropsWithoutRef<
    typeof MenubarPrimitive.Item
  >["onSelect"] = (e) => {
    !onSelectClose && e.preventDefault();
